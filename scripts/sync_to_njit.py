#!/usr/bin/env python3
"""Promote a validated ap-prediction version from eunsu-park to njit-research.
...
Example:
    ...
    python scripts/sync_to_njit.py --target /path/to/njit/ap-prediction
...
REWRITES = [
    ("eunsu-park/ap-prediction", "njit-research/ap-prediction"),
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Root of the eunsu-park ap-prediction checkout (default: this repo).",
    )
    parser.add_argument(
        "--target",
        type=Path,
        required=True,
        help="Root of the njit-research/ap-prediction working copy.",
    )
    parser.add_argument(
        "--apply",
        action="store_true",
